...
public class HttpsServer extends Thread
{
    ...
    public HttpsServer()
    {
        String ksName = System.getProperty("user.dir") + File.separatorChar + "target" + File.separatorChar
                + "test-classes" + File.separatorChar + "keystores" + File.separatorChar + "server.jks";
