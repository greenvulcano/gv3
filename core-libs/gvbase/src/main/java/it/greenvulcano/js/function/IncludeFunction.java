...
/**
 * This function perform as the C #include preprocessor directive.
 *
...
public class IncludeFunction extends BaseFunction {
     ...
     *
     */
    private static final long serialVersionUID = 7834706487900828008L;
     ...
     *            the this reference
     * @param args
     *            the first argument is the file to include
