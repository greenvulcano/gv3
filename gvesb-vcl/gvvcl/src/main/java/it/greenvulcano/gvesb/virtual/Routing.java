...
public class Routing
{
     ...
     */
    private static final Logger logger    = GVLogger.getLogger(Routing.class);
    /**
     *
     */
    ...
    */
    ...
    public void init(Node node) throws VCLException
    {
        ...
        try {
            ...
            check = (GVBufferCondition) Class.forName(className).newInstance();
            check.init(checkNode);
        }
        catch (ClassNotFoundException exc) {
            throw new InitializationException("GVVCL_CLASS_NOT_FOUND_ERROR", new String[][]{{"className", className},
                    {"key", ""}}, exc);
        }
        catch (Exception exc) {
