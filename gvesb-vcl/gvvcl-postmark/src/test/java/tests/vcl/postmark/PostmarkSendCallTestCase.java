...
import it.greenvulcano.gvesb.virtual.postmark.PostmarkSendCallOperation;
 ...
 *
 */
public class PostmarkSendCallTestCase extends TestCase
{
    ...
    private static final String     TEST_MESSAGE_2 = "<html>\n"
    + "<body>\n"
    + "  <p>Hello Developer,</p>\n"
    + "  <p>Now you can test your hard work.</p>\n"
    + "  <p>Thank you.</p>\n"
    + "  <p>Regards<br>\n"
    + "</body>\n"
    + "</html>";
...
/*    @Override
    ...
    public final void testSendEmail() throws Exception
    {
        ...
        CallOperation op = new PostmarkSendCallOperation();
        op.init(node);

        GVBuffer gvBuffer = new GVBuffer(TEST_SYSTEM, TEST_SERVICE);
        gvBuffer.setObject(TEST_MESSAGE_2);
...
/*
    ...
    public final void testSendEmailDynamicDest() throws Exception
    {
        ...
        gvBuffer.setProperty("GV_SMTP_TO",  "g.dimaio@greenvulcano.com,g.dimaio@eaisoftware.it");
        gvBuffer.setProperty("GV_SMTP_CC",  "__SOME_CC__");
        gvBuffer.setProperty("GV_SMTP_BCC", "__SOME_BCC__");
