...
public class JMSEnqueueOperation extends J2EEOperation implements EnqueueOperation
{
    ...
    private static final Logger logger      = GVLogger.getLogger(JMSEnqueueOperation.class);
            ...
            InvalidDataException, JMSException
    {
        ...
        try {
            ...
            if (isQueue) {
                Queue lQueue = (Queue) getDestination();
                ...
                Topic lTopic = (Topic) getDestination();
    ...
    /**
     * @return
     * @throws J2EEEnqueueException
     */
    protected Destination getDestination() throws J2EEEnqueueException
    {
        try {
            if (isQueue) {
                return queue;
