...
public class XAHelper
{
    ...
    /**
     * Reference of UserTransaction to Application Server.
     */
    //private UserTransaction    userT                   = null;
    /**
    ...
    private String             transactionManagerJNDI  = "java:comp/TransactionManager";

    private String             transactionManagerJNDI2 = "javax.transaction.TransactionManager";
