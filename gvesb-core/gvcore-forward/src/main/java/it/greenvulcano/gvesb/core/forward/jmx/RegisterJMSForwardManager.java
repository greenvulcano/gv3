...
/**
 * RegisterJMSForwardManager class.
 * 
 * @version 3.2.0 Gen 11, 2012
 * @author GreenVulcano Developer Team
 */
public class RegisterJMSForwardManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        descriptorName = XMLConfig.get(conf, "descriptor/@name", "JMSForwardManager");
    }
