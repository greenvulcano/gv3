 ...
 */
package it.greenvulcano.gvesb.gvadam.jmx;
 ...
 * 
 */
public class RegisterAdamManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        descriptorName = XMLConfig.get(conf, "descriptor/@name", "AdamManager");
    }
