 ...
 */
package it.greenvulcano.gvesb.gvnet.jmx;
 ...
 * 
 */
public class RegisterNetManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        descriptorName = XMLConfig.get(conf, "descriptor/@name", "NetManager");
    }
