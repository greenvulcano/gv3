 ...
 */
package it.greenvulcano.gvesb.jbpmhumantask.listener.jmx;

import it.greenvulcano.configuration.XMLConfig;
import it.greenvulcano.gvesb.jbpmhumantask.listener.GVJbpmTaskListenerManager;
...
/**
 * RegisterJbpmTaskListenerManager class.
 * 
 * @version 28/set/2010
 ...
 *         REVISION OK
 */
public class RegisterJbpmHumanTaskListenerManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        descriptorName = XMLConfig.get(conf, "descriptor/@name", "JbpmTaskListenerManager");
    }
    ...
    public final void initializeMBeanServer(MBeanServer server) throws Exception
    {
        ...
        try {
            ...
            GVJbpmTaskListenerManager.instance();
        }
        finally {
            NMDC.pop();
        }
