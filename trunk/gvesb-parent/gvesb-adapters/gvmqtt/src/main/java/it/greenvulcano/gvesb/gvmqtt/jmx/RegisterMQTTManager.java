 ...
 */
package it.greenvulcano.gvesb.gvmqtt.jmx;
 ...
 * 
 */
public class RegisterMQTTManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        descriptorName = XMLConfig.get(conf, "descriptor/@name", "MQTTManager");
    }
