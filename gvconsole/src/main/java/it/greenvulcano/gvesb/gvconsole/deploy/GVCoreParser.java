...
public class GVCoreParser
{
    ...
    public static void main(String[] args)
    {
        try {
            ...
            System.out.println(parser.getListaVCLOp("TOUPPER_A"));
            parser.aggiornaSystem("TOUPPER_A", XMLUtils.getParserInstance());
            //TextUtils.writeFile(XMLUtils.serializeDOM_S(parser.serverXml, "utf-8", false, true), "/home/gianluca/applicazioni/GvServer-3.4.0.10.Beta/GreenV/out.xml");
            parser.scriviFile();
