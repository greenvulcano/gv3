<%@ page language="java" pageEncoding="ISO-8859-1"%>
													...
													<%@ page import="it.greenvulcano.configuration.XMLConfig" %>
														...
														<div class="ui-tabs ui-widget ui-widget-content ui-corner-all">
															<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
																...
																<li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a>Adapter</a></li>
  ...
  String xmlZip = null;
   ...
   List<String> listaServizi = gvConfigZip.getListaServizi();
    xmlZip = gvConfigZip.getGvAdapters(listaServizi,false).replaceAll("'","\"").replaceAll("\n","\\\\n'\\\n+'").replaceAll("Script","GVScript");
    xmlServer = gvConfigServer.getGvAdapters(listaServizi,false).replaceAll("'","\"").replaceAll("\n","\\\\n'\\\n+'").replaceAll("Script","GVScript");
   }
   catch (Exception e) {
			e.printStackTrace();
   }
