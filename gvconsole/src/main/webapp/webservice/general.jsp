											...
											<fieldset class="ui-widget-header  ui-corner-all">
												...
												<TABLE cellpadding="0" cellspacing="2">
													<TR>
														...
														<TD class="input160">
															<bean:write name="GVWebServiceForm" property="businessWebServicesBean.authenticatedHttpSoapAddress" />
															<TD>
													...
													<TR>
														...
														<TD class="input160">
															<bean:write name="GVWebServiceForm" property="businessWebServicesBean.authenticatedHttpsSoapAddress" />
														</TD>
														<TD>
													...
													<TR>
														...
														<TD class="input160">
															<bean:write name="GVWebServiceForm" property="businessWebServicesBean.httpSoapAddress" />
														</TD>
														<TD>
													...
													<TR>
														...
														<TD class="input160">
															<bean:write name="GVWebServiceForm" property="businessWebServicesBean.httpsSoapAddress" />
														</TD>
														<TD>
													...
													<TR>
														...
														<TD class="input160">
															<bean:write name="GVWebServiceForm" property="businessWebServicesBean.servicesDirectory" />
														</TD>
														<TD>
													...
													<TR>
														...
														<TD class="input160">
															<bean:write name="GVWebServiceForm" property="businessWebServicesBean.wsdlDirectory" />
														</TD>
														<TD>
												...
												<logic:notEmpty name="GVWebServiceForm" property="uddiInfoBean">
													<TABLE cellpadding="0" cellspacing="2">
														<TR>
															<TD>Registry name:</TD>
															<TD class="input160">
																<bean:write name="GVWebServiceForm" property="uddiInfoBean.id" />
															</TD>
															<TD>
														...
														<TR>
															...
															<TD class="input160">
																<bean:write name="GVWebServiceForm" property="uddiInfoBean.urlp" />
															</TD>
															<TD>
														...
														<TR>
															...
															<TD class="input160">
																<bean:write name="GVWebServiceForm" property="uddiInfoBean.urli" />
															</TD>
															<TD>
														...
														<TR>
															...
															<TD class="input160">
																<bean:write name="GVWebServiceForm" property="uddiInfoBean.organization" />
															</TD>
															<TD>
