			...
			<fieldset class="ui-widget-header  ui-corner-all">
				...
				<TABLE cellpadding="0" cellspacing="2"> 
   				<html:form action="GVWebServiceAction" styleClass="gvdata_form"> 
									<TR> 
										<TD colspan="2"><p>Existing services</p>
										  <p>
											<font>
										 ...
										 <TD colspan="2"><p>Services to publish</p>
										   <p>
										   <font>
		  ...
		  <TD>
			<fieldset class="ui-widget-header  ui-corner-all">
				...
				<html:form action="GVWebServiceAction" styleClass="gvdata_form"> 
				  ...
				  <TABLE  cellpadding="0" cellspacing="2"> 
				  	<TR> 
                      <TD class="input160"><p>State</p>
                      <TD class="input160"><p>Name</p>
                      <TD class="input160"><p>WSDL URL</p>
                      <TD class="input160"><p>Description</p>
                      <TD class="input160"><p>Service Key</p>
                      <TD class="input160"><p>&nbsp;</p>
                    </TR>  
                    ...
                    <TR> 
                      ...
                      <TD class="input160"><c:out value="${fieldKey1.value.serviceName}"/></TD> 
                      <TD class="input160"><html:link href="${fieldKey1.value.accessURL}" target="_blank"><c:out value="${fieldKey1.value.accessURL}"/></html:link></TD> 
                      <TD class="input160"><c:out value="${fieldKey1.value.description}"/></TD> 
                      <TD class="input160"><c:out value="${fieldKey1.value.serviceKey}"/></TD> 
                      <TD class="input160"><html:checkbox property="src" value="${fieldKey1.value.serviceKey}"/></TD> 
                    </TR>
					</logic:iterate>
					 <TR> 
					   <TD colspan="6"><br>
