...
set GV_OPTS=-Dgv.app.home=/%GV_HOME% -Dgv.pop.uidcache.manager="it.greenvulcano.gvesb.virtual.pop.uidcache.MemoryUIDCacheManager" -Dit.greenvulcano.gvesb.identity.IdentityInfo.debug=true -Dorg.jruby.embed.localcontext.scope=threadsafe -Dpython.path=%GV_HOME%\scripts\jython
