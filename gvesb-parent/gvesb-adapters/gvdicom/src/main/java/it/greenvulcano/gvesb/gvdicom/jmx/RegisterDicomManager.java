 ...
 */
package it.greenvulcano.gvesb.gvdicom.jmx;
...
/**
 * RegisterDicomManager class.
 * 
 * @version 3.5.0 Sep 25, 2014
 * @author GreenVulcano Developer Team*
 * 
 */
public class RegisterDicomManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        descriptorName = XMLConfig.get(conf, "descriptor/@name", "DicomManager");
    }
    ...
    public final void initializeMBeanServer(MBeanServer server) throws Exception
    {
        ...
        try {
            ...
            GVDicomAssociationManager.instance();
            GVDicomListenerManager.instance();
        }
        finally {
            NMDC.pop();
        }
