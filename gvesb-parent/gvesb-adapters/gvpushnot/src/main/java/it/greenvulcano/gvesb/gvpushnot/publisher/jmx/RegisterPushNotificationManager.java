...
/**
 * RegisterPushNotificationManager class.
 * 
 * @version 3.4.0 16/feb/2015
 * @author GreenVulcano Developer Team
 */
public class RegisterPushNotificationManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        descriptorName = XMLConfig.get(conf, "descriptor/@name", "PushNotificationManager");
    }
    ...
    public final void initializeMBeanServer(MBeanServer server) throws Exception
    {
        ...
        try {
            ...
            GVPushNotificationManager.instance();
        }
        finally {
            NMDC.pop();
        }
