 ...
 */
public class GVSubFlowSplittedNode extends GVFlowNode
{
        ...
        try {
            ...
            try {
                ...
                while (itInput.hasNext() && !isInterrupted()) {
                    ...
                    tasks.add(new SubFlowTask(subFlowPool, currInput, onDebug, logContext));
                }
    ...
    private GVBuffer processOutput(GVBuffer inputData, List<Result> result) throws GVException {
