...
{
    private static final XPathAPI xpathAPI = new XPathAPI();
    ...
    public Object getValue(String expression, Object object) throws ExpressionEvaluatorException
    {
        try {
            ...
            if (object instanceof OMNode) {
                return xpathAPI.selectNodeList(object, new XPath(expression));
            }
            obj = XMLUtils.parseObject_S(object, false, true);
