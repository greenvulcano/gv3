...
{
    private static final Logger logger          = GVLogger.getLogger(XmlWriterImpl.class);
            ...
            switch (j) {
                ...
                case Types.BLOB :
                    ...
                    if (resultSet.wasNull()) {
                        ...
                        byte[] arrBytes = Base64.encodeBase64(BinaryUtils.inputStreamToBytes(blob.getBinaryStream()));
