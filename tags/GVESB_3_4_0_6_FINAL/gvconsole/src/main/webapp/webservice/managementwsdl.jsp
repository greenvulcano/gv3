	                    ...
	                    <TR> 
	                      ...
	                      <TD class="input160">
	                          <c:set target="${GVWebServiceForm}" property="url" value = "${fieldKey1.name}" />           	 
		                     		 <html:link href="<%=GVWebServiceForm.getBusinessValue()%>" target="_blank"><c:out value="${fieldKey1.name}"/></html:link>
	                      </TD> 
	                      <TD class="input160"><c:out value="${fieldKey1.data}"/></TD> 
	                      <TD class="input160">
