 ...
 * 
 */
public class RegisterWSDLManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        properties.put(WSDLManagerProxy.JMX_KEY_NAME, WSDLManagerProxy.JMX_KEY_VALUE);

        descriptorName = XMLConfig.get(conf, "descriptor/@name", "Axis2WSDLManager");
    }
    ...
    public final void initializeMBeanServer(MBeanServer server) throws Exception
    {
        ...
        try {
            ...
            WSDLManagerProxy proxy = new WSDLManagerProxy();
