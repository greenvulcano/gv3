 ...
 * needs. <br/>
 * 
 * @version 3.3.0 Feb 5, 2010
 * @author GreenVulcano Developer Team
 */
@Stateless(name = "gvesb/core/GreenVulcano_ejb3")
@Remote(J2EEGreenVulcano.class)
@Local(J2EEGreenVulcanoLocal.class)
@TransactionAttribute(TransactionAttributeType.SUPPORTS)
public class J2EEGreenVulcanoBean implements J2EEGreenVulcano, J2EEGreenVulcanoLocal
{
    ...
    public void init() throws CreateException
    {
        ...
        try {
            ...
            //sessionContext = (SessionContext) context.lookup("java:comp/EJBContext");
            String serverNameEntry = "jboss.server.name"; //(String) context.lookup("java:comp/env/server-name-entry");
            serverName = System.getProperty(serverNameEntry, serverNameEntry);
            rollbackOnGVPublicException = false; //Boolean.valueOf((String) context.lookup("java:comp/env/rollback-on-exception")).booleanValue();
    ...
    public GVBuffer request(GVBuffer gvBuffer) throws GVPublicException
    {
        ...
        try {
            ...
            try {
                ...
                // GreenVulcano elaborated data returned by the GreenVulcano core class
                GVBuffer gvOutputData = null;
                ...
                // The elaborated buffer is returned to the caller (usually an Adapter or a Bridge)
                return gvOutputData;
            }
            finally {
                try {
    ...
    public GVBuffer requestReply(GVBuffer gvBuffer) throws GVPublicException
    {
        ...
        try {
            ...
            try {
                ...
                // Turn the requestReply directly to the GreenVulcano core main class
                try {
                    greenVulcano = getGreenVulcano(gvBuffer);
