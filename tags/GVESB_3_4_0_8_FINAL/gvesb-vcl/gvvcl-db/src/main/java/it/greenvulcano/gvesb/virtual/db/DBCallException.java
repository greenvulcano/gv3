 ...
 */
public class DBCallException extends CallException
{
    private static final long serialVersionUID = 210L;

    /**
     * Creates a new DBCallException with error code identified by
     * <code>errorId</code> and no cause.
     *
     * @param errorId
     *        ErrorId associated to the exception
     */
    public DBCallException(String errorId)
    {
        super(errorId);
    }
     ...
     *        message.
     */
    public DBCallException(String errorId, String[][] params)
    {
     ...
     *
     * @param errorId
     *        DBCallException associated to the exception
     * @param exc
     *        Throwable that caused this exception to get thrown
     */
    public DBCallException(String errorId, Throwable exc)
    {
        super(errorId, exc);
    }

    /**
     * Creates a new DBCallException with a cause.
     *
     * @param errorId
     ...
     *        Throwable that caused this exception to get thrown
     */
    public DBCallException(String errorId, String[][] params, Throwable exc)
    {
