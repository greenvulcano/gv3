...
CREATE TABLE "GV_TEST"."EXTERNAL_CREDIT_CARD" (
	...
	"CREDIT" 	NUMBER(15,5) NOT NULL,
	"ENABLED"	VARCHAR2(1) NOT NULL,
	CONSTRAINT "EXTCCRED_PK" PRIMARY KEY("ID")
	NOT DEFERRABLE
	 VALIDATE
)
/
...
INSERT INTO "GV_TEST"."CITY"("ID", "NAME")
  VALUES(1, 'ROMA')
/
INSERT INTO "GV_TEST"."CITY"("ID", "NAME")
  VALUES(2, 'NAPOLI')
...
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(36, 'PIPPO', TO_DATE('2000-10-10 00:00:00','YYYY-MM-DD HH24:MI:SS'), 6)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(37, 'TOPOLINO', TO_DATE('2000-03-17 00:00:00','YYYY-MM-DD HH24:MI:SS'), 6)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(24, 'ANCO MARZIO', TO_DATE('1979-10-02 00:00:00','YYYY-MM-DD HH24:MI:SS'), 1)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(33, 'CIRO ROSSI', TO_DATE('1984-07-10 00:00:00','YYYY-MM-DD HH24:MI:SS'), 2)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(6, 'NUMA POMPILIO', TO_DATE('1970-10-02 00:00:00','YYYY-MM-DD HH24:MI:SS'), 1)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(8, 'TULLIO OSTILIO', TO_DATE('1975-05-05 00:00:00','YYYY-MM-DD HH24:MI:SS'), 1)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(20, 'CIRO VERDI', TO_DATE('1974-09-15 00:00:00','YYYY-MM-DD HH24:MI:SS'), 2)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(3, 'MARCO VERDI', TO_DATE('1975-02-20 00:00:00','YYYY-MM-DD HH24:MI:SS'), 4)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(34, 'ANTONIO ROSSI', TO_DATE('1980-02-05 00:00:00','YYYY-MM-DD HH24:MI:SS'), 5)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(19, 'PAOLO VERDI', TO_DATE('1974-09-15 00:00:00','YYYY-MM-DD HH24:MI:SS'), 5)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(1, 'MARIO ROSSI', TO_DATE('1960-10-10 00:00:00','YYYY-MM-DD HH24:MI:SS'), 5)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(2, 'MARIO BIANCHI', TO_DATE('1970-08-15 00:00:00','YYYY-MM-DD HH24:MI:SS'), 5)
/
INSERT INTO "GV_TEST"."PERSON"("ID", "NAME", "BIRTHDATE", "ID_CITY")
  VALUES(12, 'PAOLO ROSSI', TO_DATE('1984-07-25 00:00:00','YYYY-MM-DD HH24:MI:SS'), 5)
/
