 ...
 */
package it.greenvulcano.gvesb.gvzmq.jmx;
...
/**
 * RegisterZMQManager class.
 * 
 * @version 3.2.0 18/03/2012
 * @author GreenVulcano Developer Team
 */
public class RegisterZMQManager implements MBeanServerInitializer
{
    /**
    ...
    public final void init(Node conf) throws Exception
    {
        ...
        descriptorName = XMLConfig.get(conf, "descriptor/@name", "ZMQManager");
    }
